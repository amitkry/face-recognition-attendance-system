...
amits_encoding = face_recognition.face_encodings(amits_image)[0]
...
known_face_encodings = [amits_encoding,bhaiya_encoding]
known_face_names = ["Amit Kumar Yadav", "Santosh Kumar Yadav"]
...
while True:
    ...
    for face_encoding in face_encodings:
        ...
        #Add the text if a peerson is present
